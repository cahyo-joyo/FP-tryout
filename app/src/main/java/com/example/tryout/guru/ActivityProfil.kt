package com.example.tryout.guru
...
class ActivityProfil : AppCompatActivity() {
    ...
    fun getProfil(data : Bundle?){
        ...
        Picasso.get().load(Variabel().URL_FOTO_GURU+data.getString("foto")).into(dataDesign)
    }
    ...
    fun editProfil(id: String, nama: String, alamat: String, telp: Long,  tmp_lahir : String ,tgl_lahir : String, jenkel : String, foto : File?){
        ...
        ApiService.endpoint.editProfilGuru(id,nama,alamat,telp,tmp_lahir,tgl_lahir,jenkel,multipartBody)
